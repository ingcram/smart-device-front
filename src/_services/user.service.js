...
function register(user) {
    ...
    return fetch(`${config.apiUrl}/devices/register`, requestOptions).then(handleResponse);
}
...
function update(user) {
    ...
    return fetch(`${config.apiUrl}/devices/${user.id}`, requestOptions).then(handleResponse);;
}
